function u(){const l=[{name:"From This Device",value:["file"]},{name:"From the Web",value:["url"]},{name:"Both",value:["file","url"]}],i=`
    <h2>
...
`,s=!0,e="৳";return{markup:i,tabs:l,priceSignature:e,priceStructure:t=>`${t} ${e}`,discountPrice:(t,r,o)=>{if(o==="flat")return parseInt(t)-parseInt(r);{let a=parseInt(t)*parseInt(r)/100;return parseInt(t)-a}},spanIsRed:s}}export{u};
