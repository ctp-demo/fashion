            ...
            <div class="bookmark-wrapper d-flex align-items-center">
                ...
                <ul class="nav navbar-nav bookmark-icons">
                    <li class="nav-item d-none d-lg-block">
                        <a class="nav-link d-flex align-items-center" target="_blank" href="/">
                            <vue-feather type="globe"/>
                            <span class="ms-1">Visit Wbsite</span>
                        </a>
                    </li>
                </ul>
                ...
                <li class="nav-item dropdown dropdown-user">
                    <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none">
                            ...
                            <span class="user-status text-capitalize">{{ $page.props.auth.user.type }}</span>
                        </div>
                        <span class="avatar">
                            <img class="round" :src="$page.props.auth.user.avatar" alt="avatar" height="40" width="40">
                            <span class="avatar-status-online"></span>
                        </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                        <a class="dropdown-item" href="/panel/my-profile">
                            <vue-feather type="user" /> Profile
                        </a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="/panel/settings">
